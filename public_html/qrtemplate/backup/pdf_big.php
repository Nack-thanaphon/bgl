...
$pdf->Ln();
$pdf->SetFont('tahoma','',20);
$pdf->MultiCell( 180  , 5 , iconv( 'UTF-8','cp874' , '                Gemstone Identification Report') );
$pdf->Ln();
$pdf->MultiCell( 170  , 5, iconv( 'UTF-8','cp874' , '' ) );
$pdf->Ln();
$pdf->SetFont('tahoma','',20);
$pdf->MultiCell( 180  , 7 , iconv( 'UTF-8','cp874' , 'Report number     '.$file_number.'') );
$pdf->Ln();
$pdf->SetFont('tahoma','',15);
$pdf->MultiCell( 170  , 7 , iconv( 'UTF-8','cp874' , 'Date                             '.$d.''.$list_day.' '.$str_m.' '.$y.'') );
$pdf->Ln();
$pdf->SetFont('tahoma','',20);
$pdf->MultiCell( 170  , 7 , iconv( 'UTF-8','cp874' , 'Laboratory Report') );
$pdf->Ln();
$pdf->SetFont('tahoma','',15);
...
$pdf->Ln();
$pdf->SetFont('tahoma','',15);
$pdf->MultiCell( 170  , 7 , iconv( 'UTF-8','cp874' , 'Magnification                 '.$magnification.'' ) );
$pdf->Ln();
$pdf->SetFont('tahoma','',15);
$pdf->MultiCell( 170  , 7 , iconv( 'UTF-8','cp874' , 'Identification                 '.$identification.'' ) );
$pdf->Ln();
$pdf->SetFont('tahoma','',15);
$pdf->MultiCell( 170  , 10 , iconv( 'UTF-8','cp874' , 'Color                            '.$color.'' ) );
$pdf->Ln();
$pdf->SetFont('tahoma','',15);
$pdf->MultiCell( 170  , 7 , iconv( 'UTF-8','cp874' , 'Comments : '.$conment.'' ) );
$pdf->Ln();
$pdf->SetFont('tahoma','',15);
$pdf->MultiCell( 170  , 20 , iconv( 'UTF-8','cp874' , '' ) );
$pdf->Ln();
$pdf->Image($photo,160,90,30);
$pdf->Ln();
