		...
		<header>
			<div id="header">
					...
					<div class="inner">
						...
						<nav class="main_menu">
							<ul>
								...
								<li class="current_page_item"><a href="contact.php">ติดต่อเรา<span class="subtext">contact us</span></a></li>
							</ul>
						</nav>
				...
				<section class="section_title">
					<div class="inner">
						<div class="block_title"><h1>ติดต่อเรา</h1></div>
						<div class="clearboth"></div>
					</div>
				</section>
			...
			<div class="inner">
				<div class="general_content">
					<div class="main_content">
                        ...
                        <div class="item">
								<div class="image">
									<img src="images/gems_center.jpg" alt="">
						  </div>
								
								<div class="description">
									<h5>ข้อมูลติดต่อ</h5>
									<p class="tags">อาคารศูนย์ส่งเสริมอัญมณีและเครื่องประดับ</p>
									<p>วันจันทร์-วันพฤหัสบดี  เปิดทำการเวลา 8.30-16.30 น. <br>
                                    ณ ห้องปฏิบัติการอัญมณี คณะอัญมณี มหาวิทยาลัยบูรพา <br>
                                    ชั้น 1 อาคารศูนย์ส่งเสริมอัญมณีและเครื่องประดับ จ.จันทบุรี <br>
                                    เลขที่ 1/29 ถนนมหาราช ต.ตลาด อ.เมือง จ.จันทบุรี  22000</p>
                                    <p>โทรศัพท์ (+66) 85-3868595 <br>
                                    อีเมล์ : <a href="mailto:labbgl@go.buu.ac.th " target="_blank">labbgl@go.buu.ac.th </a><br>
                                    Facebook fan page : <a href="https://www.facebook.com/BGLLAB/" target="_blank">https://www.facebook.com/BGLLAB</a></p>
								</div>
					    ...
					    <div class="item">
								<div class="image">
									<img src="images/chan_gems.jpg" alt="">
			    </div>
								
								<div class="description">
									<p class="tags">อาคารจันท์เจมส์</p>
                                    <p>วันศุกร์และวันเสาร์ เปิดทำการเวลา  9.00-17.00 น. <br>
                                    ณ ห้องปฏิบัติการอัญมณี ชั้น 2 อาคารจันท์เจมส์ <br>
                                    เลขที่ 189 ถนนศรีจันทร์ ต.วัดใหม่ อ.เมือง จ.จันทบุรี 22000 </p>
                                    <p>โทรศัพท์ (+66) 85-3868595 <br>
                                    อีเมล์ : <a href="mailto:labbgl@go.buu.ac.th" target="_blank">labbgl@go.buu.ac.th</a><br>
                                    Facebook fan page : <a href="https://www.facebook.com/BGLLAB/" target="_blank">https://www.facebook.com/BGLLAB</a></p>
								</div>
					    ...
					    <div class="item">
								<div class="image">
									<img src="images/buu_chan.png" alt="">
	          </div>
								
								<div class="description">
									<p class="tags">ห้องปฏิบัติการอัญมณี คณะอัญมณี</p>
									<p>ห้องปฏิบัติการอัญมณี คณะอัญมณี <br>มหาวิทยาลัยบูรพา วิทยาเขตจันทบุรี <br>ที่อยู่ 57 ถนนชลประทาน หมู่ 1 ต.โขมง อ.ท่าใหม่ จ.จันทบุรี 22000 <br>เบอร์โทรศัพท์ (+66)85-3868595 แฟกซ์ 039-310144<br>
                                  	Website : <a href="http://www.chanthaburi.buu.ac.th/~gems/index.php" target="_blank">http://www.chanthaburi.buu.ac.th/~gems</a><br>
										Webmaster : <a href="mailto:arees@go.buu.ac.th" target="_blank">Aree Kotanun</a></p>
								</div>
