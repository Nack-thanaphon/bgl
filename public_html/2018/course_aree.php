		...
		<header>
			<div id="header">
				...
				<section class="section_title">
					<div class="inner">
						<div class="block_title"><h1>หลักสูตรอบรม</h1></div>
                    <div class="clearboth"></div>
					</div>
				</section>
			...
			<div class="inner">
				<div class="general_content">
					<div class="main_content"><br>
						<h3 class="heading_w_icon"><a href="#">หลักสูตรอบรมการดูพลอยเบื้องต้น</a></h3>
				  	 	<h3 class="heading_w_icon"><a href="#">หลักสูตรอบรมการวิเคราะห์พลอยด้วยเครื่องมือพื้นฐาน</a></h3>
					  <div class="clearboth"></div>
