	...
	<div class="wrapper sticky_footer">
	  ...
	  <ul>
		          ...
		          <li><a href="certificate_ck.php" target="_blank" class="loginBtn">ตรวจสอบใบรับรอง<span class="subtext">Verify A Report</span></a></li>
               	        ...
               	        <li class="current_page_item"><a href="gallery.php">ข้อมูลอัญมณี<span class="subtext">Gemstone Information</span></a></li>
				...
				<section class="section_title">
					<div class="inner">
						<div class="block_title"><h1>Inclusion Gallery</h1></div>
						<div class="clearboth"></div>
					</div>
				</section>
			...
			<div class="inner">
				<div class="general_content">
					<div class="main_content">
						<div class="separator" style="height:29px;"></div>
							<div class="item">
								<div class="image"> <a href="gallery.php"><img src="images/inclusion-gallery.jpg" alt=""></a></div>
						      </div><br><br>
                              
                              <div class="block_latest_projects_1">
							
							  <div class="project">
									<h4><a href="http://www.chanthaburi.buu.ac.th/~newsbuu/?select=news&m=detail&id=764" target="_blank">Apatite</a></h4>
							  <div class="line_2"></div>
						  </div>
							
							<div class="project">
									<h4><a href="http://www.chanthaburi.buu.ac.th/~newsbuu/?select=news&m=detail&id=765" target="_blank">Aquamarine9</a></h4>
							  <div class="line_2"></div>
						  </div>
							
							<div class="project">
									<h4><a href="http://www.chanthaburi.buu.ac.th/~newsbuu/?select=news&m=detail&id=763" target="_blank">Beryl Aquamarine</a></h4>
							  <div class="line_2"></div>
						  </div>
							
							<div class="project">
									<h4><a href="http://www.chanthaburi.buu.ac.th/~newsbuu/?select=news&m=detail&id=766" target="_blank">Beryl Emerald</a></h4>
							  <div class="line_2"></div>
						  </div>
