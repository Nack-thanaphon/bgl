		...
		<header>
			<div id="header">
				<section class="section_top">
					<div class="inner">
						...
						<nav class="main_menu">
                			...
                			<li class="current_page_item"><a href="#" class="loginBtn">ตรวจสอบใบรับรอง<span class="subtext">Verify A Report</span></a></li>
				...
				<section class="section_title">
					<div class="inner">
						<div class="block_title"><h1>ตรวจสอบใบรับรอง :</h1></div>
						...
						<div class="block_about">
							<div class="main">
								<div class="block_contact_us_type_1">
									<h4>ตรวจสอบใบรับรอง Verify A Report</h4>
									<div class="send_message" style="width: 100%;">
										<div class="form">
											<form name="form_chk" id="form_chk" action="chk_file_number.php" method="post" onSubmit="return ChkFromFile_number();">
												<div style="width: 46%; float: left; padding-left: 2%; padding-right: 2%;">
													<p class="label" for="file_number">File Number: <span>(required)</span></p>
													<div class="field"><input type="text" id="file_number" name="file_number" class="req" /></div>
												</div>
												<div style="width: 46%; float: left; padding-left: 2%; padding-right: 2%;">
													<p class="label" for="weight">Weight: <span>(required)</span></p>
													<div class="field"><input type="text" id="weight" name="weight" class="req"/></div>
												</div>
												<div style="width: 96%; float: left; padding-left: 2%; padding-right: 2%;">
													<div class="button"><input type="submit" value="Submit" class="general_button" name="submit" /></div>
												</div>
											</form>
										</div>
									</div>
                          ...
                          <div class="block_portfolio_1 c_2"><br><br>
							<div class="item">
								<div class="image"> <a href="gallery.php"><img src="images/gemstone.jpg" alt=""></a>
