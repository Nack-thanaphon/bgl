		...
		<header>
			<div id="header">
				...
				<section class="section_title">
					<div class="inner">
						<div class="block_title"><h1>การรับ-ส่งตัวอย่างทางไปรษณีย์</h1></div>
                    <div class="clearboth"></div>
					</div>
				</section>
			...
			<div class="inner">
				<div class="general_content">
				  <div class="main_content"><br>
						<h2 class="heading_w_icon"><a href="#">โปรดอ่าน!!!!</a></h2>
					  	<h3><a href="#">» รายละเอียดและเงื่อนไขการใช้บริการรับ – ส่ง ตัวอย่างทางไปรษณีย์</a></h3>
						<h3><a href="#">» ค่าบริการรับ-ส่ง ตัวอย่างทางไปรษณีย์</a></h3>
						<h2 class="heading_w_icon"><a href="#" target="_blank">แบบฟอร์มการรับ-ส่งเอกสารทางไปรษณีย์</a></h2>
                    <a href="https://track.thailandpost.co.th/" target="_blank"><img src="images/thai-post-tracking.jpg"></a>
			      </div>
                 <div class="clearboth"></div>
				</div>
			</div>
