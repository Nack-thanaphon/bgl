      ...
      <section class="section_title">
        <div class="inner">
          <div class="block_title">
            <h1>การรับ-ส่งตัวอย่างทางไปรษณีย์</h1>
          </div>
          <div class="clearboth"></div>
        </div>
      </section>
    ...
    <div class="inner">
      <div class="general_content">
        <div class="main_content"><br>
          <div class="item">
            <div class="image"> <img src="images/pls.jpg" alt=""></div>
            <br>
            <br>
          </div>
          <h3 class="heading_w_icon">ขั้นตอนการให้บริการ รับ – ส่งตัวอย่าง</h3>
          <ul class="list_2">
            <li><a href="documents/post006.pdf" target="_blank">The sending procedure of gems to BGL</a></li>
            <li><a href="documents/post007.pdf" target="_blank">ขั้นตอนการให้บริการรับ-ส่งตัวอย่างทางไปรษณีย์</a></li>
          </ul>
          <h3 class="heading_w_icon"><a href="documents/post002.pdf" target="_blank">เงื่อนไขการใช้บริการ รับ – ส่งตัวอย่าง</a></h3>
          <h3 class="heading_w_icon"><a href="documents/post003.pdf" target="_blank">การถ่ายรูปตัวอย่าง </a></h3>
          <h3 class="heading_w_icon"><a href="documents/post008.pdf" target="_blank">ค่าบริการ รับ – ส่ง ตัวอย่างทางไปรษณีย์</a></h3>
          <h3 class="heading_w_icon"><a href="documents/post005.pdf" target="_blank">อัตราค่าบริการออกใบรับรองและใบรายงานผล</a></h3>
          <div class="item">
            <div class="image"> <a href="documents/form002.pdf" target="_blank"><img src="images/form_post.jpg" alt=""></a></div>
            <br>
            <br>
          </div>
          <a href="https://track.thailandpost.co.th/" target="_blank"><img src="images/thai-post-tracking.jpg"></a> </div>
        <div class="clearboth"></div>
      </div>
    </div>
  </div>
