				...
				<div class="general_content">
					<div class="main_content">
                           ...
                           <div class="block_latest_from_blog_2">
							...
							<div class="news">
							  <?php
								...
								$sql = "select * from news_tbl where  `news_title` LIKE '%BGL%' and news_status = '1' and category_id != '1' and  news_datetime_start <= '$datetime_today' and news_datetime_end >= '$datetime_today' order by  `news_tbl`.`news_datetime_start` DESC LIMIT 0,4";
							...
							<div class="clearboth"></div>
                         <a href="#" target="_blank" class="general_button fr">อ่านข่าวทั้งหมด</a>
						</div>	
						...
						<div class="line_2" style="margin:37px 0px 35px;"></div>
                            ...
                            <div class="item">
								<div class="image"><a href="report.php" target="_blank"><img src="images/service_banner.jpg" alt=""></a>
		            		</div>
								<div class="clearboth"></div>
	    			</div>                            
                    <div class="item">
								<div class="image"><a href="certificate_ck.php" target="_blank"><img src="images/verify_banner.jpg" alt=""></a>
		            		</div>
								<div class="clearboth"></div>
	    			</div>							
						...
						<h2>วันเวลาเปิดทำการ</h2>
                        <h3>วันจันทร์-วันพฤหัสบดี เปิดทำการเวลา 8.30-16.30 น. (อาคารศูนย์ส่งเสริมอัญมณีและเครื่องประดับ)</h3>
						<p>ณ ห้องปฏิบัติการอัญมณี คณะอัญมณี มหาวิทยาลัยบูรพา ชั้น 1 อาคารศูนย์ส่งเสริมอัญมณีและเครื่องประดับ จ.จันทบุรี<br> เลขที่ 1/59 ถนนมหาราช ต.ตลาด อ.เมือง จ.จันทบุรี 22000</p><br>
                        <h3>วันศุกร์และวันเสาร์ เปิดทำการเวลา 9.00-17.00 น.(อาคารจันท์เจมส์)</h3>
                        <p>ณ ห้องปฏิบัติการอัญมณี ห้อง D204 ชั้น 2 อาคารจันท์เจมส์ เลขที่ 189 ถนนศรีจันทร์ ต.วัดใหม่ อ.เมือง จ.จันทบุรี 22000</p><br><br>
						<h2>Office Hours</h2>
                        <h3>Monday – Thursday 8.30 a.m. – 4.30 p.m. (Head Office)</h3>
						<p>Chanthaburi Gem and Jewelry Center Building (1st Floor), 1/59 Maharaj Rd., T. Tarad, A. Muang, Chanthaburi 22000, Thailand</p><br>
                        <h3>Friday – Saturday 9.00 a.m. – 5 p.m. (Branch)</h3>
                        <p>Chan Gems Building (2nd Floor), 189 Srichan Rd., T. Wat Mai, A. Muang, Chanthaburi 22000, Thailand </p><br>                        
                        <h3>Tel. &nbsp;&nbsp;+66 853868595<br>
                          <br>
                        Website: http://bgl.chanthaburi.buu.ac.th/<br><br>
                        Email : <a href="mailto:labbgl@go.buu.ac.th">labbgl@go.buu.ac.th </a><br></h3>
                        <div class="line_2" style="margin:12px 0px 34px;"></div>
                        <div class="clearboth"></div>
						</div>                            
