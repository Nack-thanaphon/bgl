		...
		<header>
			<div id="header">
				...
				<section class="section_title">
					<div class="inner">
						<div class="block_title"><h1>ข้อมูลอัญมณี/Gemstone Information</h1></div>
						<div class="clearboth"></div>
					</div>
				</section>
				...
				<div class="general_content">
					<div class="main_content">
						<div class="separator" style="height:29px;"></div>
							<div class="item">
								<div class="image"> <a href="gallery.php"><img src="images/gemstone.jpg" alt=""></a></div>
						      </div><br><br>
                              <div class="block_table_2">
...
$.ajax({
    ...
    error: function(jqXHR, textStatus, errorThrown){
        alert('Error: ' + textStatus + ' - ' + errorThrown);
						...
						<p>UPDATE 28/02/2563 Time 15.26</p>
