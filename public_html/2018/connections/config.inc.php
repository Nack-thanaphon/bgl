...
$result_campus = mysqli_query($link, $sql_campus) or die("Invalid query: " . mysqli_connect_error());
...
$result_admin = mysqli_query($link, $sql_admin) or die("Invalid query: " . mysqli_connect_error());
