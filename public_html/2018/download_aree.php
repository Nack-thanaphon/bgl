		...
		<header>
			<div id="header">
				...
				<section class="section_title">
					<div class="inner">
						<div class="block_title"><h1>เอกสารดาวน์โหลด</h1></div>
                    <div class="clearboth"></div>
					</div>
				</section>
			...
			<div class="inner">
				<div class="general_content">
					<div class="main_content"><br>
						<h3 class="heading_w_icon"><a href="documents/form001.pdf" target="_blank">แบบฟอร์มขอใช้เครื่องมือขั้นสูง</a></h3>
				  	  	<h3 class="heading_w_icon"><a href="#">แบบฟอร์ม...</a></h3>
					  <div class="clearboth"></div>
