...
$row = mysqli_fetch_array($result);
	...
	$gallery_status = $row['gallery_status'];
		if ($gallery_picture != ""){
			...
			$gallery_picture_print = "<br><img src='../file_gallery/$gallery_picture' /><br><br>";
		} else {
			$gallery_picture_print = "";
		}

?>
        <form id="form_add" name="form_add" method="post" action="gallery_edit_record.php" enctype="multipart/form-data" onsubmit="return ChkFrom();">
          <p>
            <label>หัวข้อรูปภาพ:</label><br />
            <input name="gallery_name" type="text" class="text medium" id="gallery_name" value="<?php echo "$gallery_name";?>" maxlength="100" />
            <span class="note error">*</span>
          </p>
          <p>
            <label>URL YouTube:</label><br />
            <input name="gallery_url" type="text" class="text big" id="gallery_url" value="<?php echo "$gallery_url";?>" maxlength="255" />
            <span class="note error">*</span>
          </p>
          <p class="fileupload">
            <label>รูปภาพ Gallery:<span class="note">(*.jpg, *.jpeg, *.png, *. gif)</span></label><br />
            <?php echo"$gallery_picture_print";?>
          ...
          <p>
            ...
            <input name="gallery_id" type="hidden" id="gallery_id" value="<?php echo"$gallery_id";?>" />
            <input name="file_del" type="hidden" id="file_del" value="<?php echo"$gallery_picture";?>" />
