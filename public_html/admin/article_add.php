...
function ChkFrom(){
	...
	if(document.form_add.fileupload.value == "") {
		alert("โปรดกรอกไฟล์ความรู้ทั่วไปค่ะ");
...
?>
        <form id="form_add" name="form_add" method="post" action="article_add_record.php" enctype="multipart/form-data" onsubmit="return ChkFrom();">
          <p>
            <label>หัวข้อความรู้ทั่วไป:</label><br />
            <input name="article_name" type="text" class="text medium" id="article_name" maxlength="100" />
