            ...
            <div class="wrapper">
                ...
                <div class="block">
                    ...
                    <div class="block_content">
                        ...
                        ?>
                        <form id="form_add" name="form_add" method="post" action="ref_shape_add_record_new.php" enctype="multipart/form-data" onsubmit="return ChkFrom();">
                            <p>
                            <table  border="0" cellpadding="0" cellspacing="0" style="padding: 0" width="100%">
                                <tr>
                                    ...
                                    <td >
                                        <input name="name" type="text" class="text big" maxlength="20" />
                                    </td>
                                </tr>
                                <tr>
                               	  <td>รูป Shape<span class="note error">*</span></td>
                                    <td></td>
                                    <td><input type="file" name="pic" id="fileField" /></td>
                                </tr>
                            </table>
