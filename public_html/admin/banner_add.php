...
?>
        <form id="form_add" name="form_add" method="post" action="banner_add_record.php" enctype="multipart/form-data" onsubmit="return ChkFrom();">
          <p>
            <label>หัวข้อรูปภาพ:</label><br />
            <input name="banner_name" type="text" class="text medium" id="banner_name" maxlength="100" />
