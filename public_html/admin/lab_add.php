...
?>
        <form id="form_add" name="form_add" method="post" action="lab_add_record.php" enctype="multipart/form-data" onsubmit="return ChkFrom();">
          <p>
            <label>หัวข้อความรู้ทั่วไป:</label><br />
            <input name="lab_name" type="text" class="text medium" id="lab_name" maxlength="100" />
